...
{
       0,   256,   257,   258,    42,    47,    43,    45,    10,    40,
      41
};
# endif
...
#line 18 "gram.y" /* yacc.c:1646  */
    { printf("\nResult: %f", (yyvsp[-1])); return (yyvsp[-1]);}
